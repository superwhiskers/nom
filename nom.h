...
void nom_buffer_readbits(struct nom_buffer *, unsigned long long *, long long,
			 long long);
...
void nom_buffer_readbitsnext(struct nom_buffer *, unsigned long long *,
			     long long);
...
void nom_buffer_setbits(struct nom_buffer *, long long, unsigned long long,
			long long);
...
void nom_buffer_writebytes(struct nom_buffer *, long long, long long,
			   unsigned char *);
...
void nom_buffer_readbytes(struct nom_buffer *, unsigned char *, long long,
			  long long);
